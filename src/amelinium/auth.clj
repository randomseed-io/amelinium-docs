...
(defn wrap-auth
  ...
  (let [s (-> settings
              ...
              (update :confirmation/expires (fnil time/parse-duration [10 :minutes]))
              (update :registration/expires (fnil time/parse-duration [10 :minutes]))
              (update :confirmation/max-attempts safe-parse-long 3))]
